...
import reger.core.agotext.units.*;
...
{
    public static final TimeUnit MILLISECOND = new Millisecond();
    public static final TimeUnit SECOND = new Second();
    public static final TimeUnit MINUTE = new Minute();
    public static final TimeUnit HOUR = new Hour();
    public static final TimeUnit MONTH = new Month();
    public static final TimeUnit DAY = new Day();
    public static final TimeUnit JUST_NOW = new JustNow();
    public static final TimeUnit WEEK = new Week();
    public static final TimeUnit YEAR = new Year();
    public static final TimeUnit DECADE = new Decade();
    public static final TimeUnit CENTURY = new Century();
    public static final TimeUnit MILLENNIUM = new Millennium();
