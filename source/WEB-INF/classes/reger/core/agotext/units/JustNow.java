...
public class JustNow implements TimeUnit
{
    private static final TimeFormat defaultFormat = new BasicTimeFormat().setPattern("%u").setFutureSuffix("right now")
            .setPastSuffix("moments ago");

    private TimeFormat format = defaultFormat;
    private long maxQuantity = 1000 * 60 * 5;
