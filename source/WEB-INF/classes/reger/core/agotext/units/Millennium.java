...
public class Millennium implements TimeUnit
{
    ...
    private final long millisPerUnit = 31556926000000L;
    private String name = "millennium";
    private String pluralName = "millennia";
